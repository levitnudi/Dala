...
public final class Constants {
    ...
    public static String URL_TOPICS = "https://www.api.afririse.com/2show/topics.txt";
    public static String URL_VERSION = "https://www.api.afririse.com/2show/version.txt";
    public static boolean FETCHED = false;
    public static int ADFLY_LINK_POS = 1;
    public static String DESTINATION_URL = "";
    public static Boolean SHOWADF_LY = false;
    public static final String FEED_ID = "feedid";
    public static final String ADFLYNK = "http://adf.ly/";
