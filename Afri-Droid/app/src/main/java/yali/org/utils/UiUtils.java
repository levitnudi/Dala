...
public class UiUtils {
  ...
  /*  static public void setPreferenceTheme(Activity a) {
        if (PrefUtils.getBoolean(PrefUtils.LIGHT_THEME, false)) {//!PrefUtils.getBoolean(PrefUtils.LIGHT_THEME, false)
            a.setTheme(R.style.Theme_Dark);//R.style.Theme_Dark
        }
    }*/
  static public void setPreferenceTheme(Activity a) {
