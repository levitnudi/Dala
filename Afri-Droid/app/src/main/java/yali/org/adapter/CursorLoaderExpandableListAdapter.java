...
public abstract class CursorLoaderExpandableListAdapter extends BaseExpandableListAdapter {
     ...
     */
    public CursorLoaderExpandableListAdapter(AppCompatActivity activity, Uri groupUri, int collapsedGroupLayout, int expandedGroupLayout, int childLayout) {
        mActivity = activity;
     ...
     */
    public CursorLoaderExpandableListAdapter(AppCompatActivity activity, Uri groupUri, int groupLayout, int childLayout) {
     ...
     * <p/>
     * It is your responsibility to manage this Cursor through the Activity lifecycle. It is a good idea to use {@link AppCompatActivity#managedQuery} which will handle this for you. In some situations, the
