...
import yali.org.R;
import yali.org.enums.Position;
import yali.org.helpers.BitmapHelper;
import yali.org.helpers.ColorHelper;
import yali.org.helpers.TypefaceHelper;
import yali.org.helpers.UrlParser;
import yali.org.listeners.BroadCastManager;
import yali.org.utils.UiUtils;

import static yali.org.Constants.ADFLYNK;
import static yali.org.Constants.ADFLY_LINK_POS;
import static yali.org.Constants.DESTINATION_URL;
...
/*      AdView adView = new AdView(this,
     ...
     /* RelativeLayout relativeLayout = new RelativeLayout(this);
      RelativeLayout.LayoutParams adViewParams = new RelativeLayout.LayoutParams
              (AdView.LayoutParams.WRAP_CONTENT, AdView.LayoutParams.WRAP_CONTENT);
  ...
  public class MyWebChromeClient extends WebChromeClient {
    ...
    public class MyWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            if(!url.contains(ADFLYNK)){
                DESTINATION_URL = url;
            }

           /* CookieSyncManager.createInstance(FinestWebViewActivity.this);
            CookieManager cm = CookieManager.getInstance();
            Toast.makeText(FinestWebViewActivity.this, cm.getCookie(Constants.DESTINATION_URL), Toast.LENGTH_LONG).show();*/
       ...
       ******************************************************/
                ...
                if(!shared.getString("ref1", "opt-out").equals("opt-out")){
                  ...
                  if(ADFLY_LINK_POS==1) {
                    url = ADFLYNK + shared.getString("ref1", getString(R.string.default_referral_id)) + "/" + url;
                    ADFLY_LINK_POS=2;
                  }else if(ADFLY_LINK_POS==2){
                    url = ADFLYNK + shared.getString("ref2", getString(R.string.default_referral_id)) + "/" + url;
                    ADFLY_LINK_POS=3;
                  }else if(ADFLY_LINK_POS==3){
                    url = ADFLYNK +  getString(R.string.default_referral_id) + "/" + url;
                    ADFLY_LINK_POS=1;
                  }

                  editor.putInt("LINKPOS", ADFLY_LINK_POS);
                  editor.commit();
                }
 ...
 private final String TAG = FinestWebViewActivity.class.getSimpleName();
  public void initInterstitialAds(){
    ...
    interstitialAd = new InterstitialAd(this, getString(R.string.fb_test_ad)+
 ...
 /*   private NativeAd nativeAd;
    ...
    private void loadNativeAd() {
        ...
        // While you are using this temporary code you will only get test ads and if you release
        // your code like this to the Google Play your users will not receive ads (you will get a no fill error).
        nativeAd = new NativeAd(this, getString(R.string.fb_test_ad)+getString(R.string.fb_native_placement_id));
